...
(function(b){b.organicTabs=function(c,d){var a=this;a.$el=b(c);a.$nav=a.$el.find(".navtab");a.init=function(){a.options=b.extend({},b.organicTabs.defaultOptions,d);b(".hide").css({position:"relative",top:0,left:0,display:"none"});a.$nav.delegate("li > a","click",function(){var c=a.$el.find("a.current").attr("href").substring(1),g=b(this),e=g.attr("href").substring(1),f=a.$el.find(".list-tabwrap"),d=f.height();f.height(d);e!=c&&0==a.$el.find(":animated").length&&a.$el.find("#"+c).fadeOut(a.options.speed,function(){a.$el.find("#"+e).fadeIn(a.options.speed);var b=a.$el.find("#"+e).height();f.animate({height:b});a.$el.find(".navtab li a").removeClass("current");g.addClass("current")});return!1})};a.init()};b.organicTabs.defaultOptions={speed:300};b.fn.organicTabs=function(c){return this.each(function(){new b.organicTabs(this,c)})}})(jQuery);
...
window.searchxx=function(){return function(a){a=a||{};var m=a.url_blog||window.location.host,n=a.srcBlank||"http://1.bp.blogspot.com/-htG7vy9vIAA/Tp0KrMUdoWI/AAAAAAAABAU/e7XkFtErqsU/s1600/grey.gif",p=a.findText||"Search results for keyword",q=a.NotfindText||"No result!",r=a.ErrorText||"Error loading feed.",s=a.ErrorText||"Loading...",j=a.scrthumbSize||50,k=a.summaryLength||0,e=jQuery;a=e("#ajax-search-form");var t=a.find(":text");a.append('<div id="search-result"></div>');var g=e("#search-result");a.on("submit",function(){var a=t.val();g.show().html(s);e.ajax({url:"http://"+m+"/feeds/posts/summary?alt=json-in-script&q="+a+"&max-results=9999",type:"get",dataType:"jsonp",success:function(b){b=b.feed.entry;var c,h,e,l,f="";if(void 0!==b){for(var f="<h4>"+p+" &quot;"+a+"&quot;</h4>",f=f+'<a class="close" href="/">&times;</a><ol>',d=0;d<b.length;d++){h=RegExp(a,"ig");e=b[d].title.$t.replace(h,"<mark>"+a+"</mark>");for(c=0;c<b[d].link.length;c++)"alternate"==b[d].link[c].rel&&(l=b[d].link[c].href);c="content"in b[d]?b[d].content.$t:"summary"in b[d]?b[d].summary.$t:"";c=c.replace(/<\S[^>]*>/g,"");c.length>k&&(c=c.substring(0,k)+"...");c=c.replace(h,"<mark>"+a+"</mark>");h="media$thumbnail"in b[d]?b[d].media$thumbnail.url.replace(/\/s[0-9]+\-c/g,"/s"+j+"-c"):n;f+='<li><a href="'+l+'" target="_blank"><span><img width="'+j+'" height="'+j+'" src="'+h+'"/></span><b>'+e+"</b></a><p>"+c+"</p></li>"}g.html(f+"</ol>")}else g.html('<a class="close" href="/">&times;</a><strong>'+q+"</strong>")},error:function(){g.html('<a class="close" href="/">&times;</a><strong>'+r+"</strong>")}});return!1});a.on("click",".close",function(){g.fadeOut();return!1})}}();
function createCookie(c,d,e){if(e){var b=new Date();b.setTime(b.getTime()+(e*24*60*60*1000));var a="; expires="+b.toGMTString()}else{var a=""}document.cookie=c+"="+d+a+"; path=/"}function readCookie(b){var e=b+"=";var a=document.cookie.split(";");for(var d=0;d<a.length;d++){var f=a[d];while(f.charAt(0)==" "){f=f.substring(1,f.length)}if(f.indexOf(e)==0){return f.substring(e.length,f.length)}}return null}function eraseCookie(a){createCookie(a,"",-1)};
window.viewMode=function(){return function(a){a=(a||{}).viewmodedefault||"list";var b=function(){f.addClass("grid").removeClass("list");d.addClass("active");e.removeClass("active");createCookie("grid",null,1E4);eraseCookie("list");return!1},c=function(){f.removeClass("grid").addClass("list");d.removeClass("active");e.addClass("active");createCookie("list",null,1E4);eraseCookie("grid");return!1},f=$(".blog-posts.hfeed").find(".post"),d=$("#view .grid"),e=$("#view .list");readCookie("grid")&&"list"!=a?(b(),eraseCookie("grid")):readCookie("list")&&"list"!=a?(c(),eraseCookie("list")):readCookie("grid")?(b(),eraseCookie("grid")):readCookie("list")?(c(),eraseCookie("list")):"list"!=a?(b(),eraseCookie("grid")):(c(),eraseCookie("list"));d.click(b);e.click(c)}}();
function footertoggle(){var a=readCookie("hfooterx");null==a&&(createCookie("hfooterx","off",0),$("#isifooternya").attr("style","display:none"),$(".clickfooter").addClass("active"));"off"==a&&($("#isifooternya").attr("style","display:none"),$(".clickfooter").addClass("active"));$(".clickfooter").live("click",function(){var a=readCookie("hfooterx");if("on"==a)return $("#isifooternya").animate({height:"hide"},{duration:"slow"}),$(this).addClass("active"),createCookie("hfooterx","off",0),!1;if("off"==a)return $("#isifooternya").animate({height:"show"},{duration:"slow"}),$(this).removeClass("active"),createCookie("hfooterx","on",0),!1})};
function RecentbyTag(m){var e=jQuery,a={blogURL:"",MaxPost:5,idcontaint:"#rcbytag",thumbSize:70,cmtext:"comments",firstcmtext:"comment",loadingClass:"loadingxx",Moretext:"More artikel",NumCharacter:100,pBlank:"http://2.bp.blogspot.com/-D47WWjFZXdk/UP1z-A5uCuI/AAAAAAAAH98/heTBvxq49No/s1600/noimage.jpg",NoCmtext:"No Comment",MonthNames:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),tagName:!1},a=e.extend({},a,m),j=e(a.idcontaint),n=""==a.blogURL?window.location.protocol+"//"+window.location.host:a.blogURL;j.addClass(a.loadingClass);var k=function(b){var g,c,e,k,f,p,h,l="";b=b.feed.entry;if(void 0!==b){for(var l="<ul class='recntbytag'>",d=0;d<b.length;d++){for(c=0;c<b[d].link.length;c++)if("alternate"==b[d].link[c].rel){g=b[d].link[c].href;break}for(c=0;c<b[d].link.length;c++)if("replies"==b[d].link[c].rel&&"text/html"==b[d].link[c].type){e=b[d].link[c].title.split(" ")[0];break}f="content"in b[0]?b[0].content.$t:"summary"in b[0]?b[0].summary.$t:"";f=f.replace(/<\S[^>]*>/g,"");f.length>a.NumCharacter&&(f=f.substring(0,a.NumCharacter)+"...");k=0==e?' <span class="cm">'+a.NoCmtext+"</span>":1==e?' <span class="cm">'+e+" "+a.firstcmtext+"</span>":' <span class="cm">'+e+" "+a.cmtext+"</span>";thumbpostimg="media$thumbnail"in b[0]?b[0].media$thumbnail.url.replace(/\/s[0-9]+\-c/g,"/s"+a.thumbSize+"-c"):a.pBlank.replace(/\/s[0-9]+(\-c|\/)/,"/s"+a.thumbSize+"$1");c=b[d].title.$t;h=b[d].published.$t.substring(0,10);var m=h.substring(0,4),q=h.substring(5,7);h=h.substring(8,10);q=a.MonthNames[parseInt(q,10)-1];b[d]==b[0]?(p="<p>"+f+"</p>",f='<a title="'+c+'" target="_blank" class="thumbx" href="'+g+'"><img style="width:'+a.thumbSize+"px;height:"+a.thumbSize+'px;display:block;" src="'+thumbpostimg+'"/></a>'):f=p="";l+='<li class="number'+d+'" >'+f+'<strong><a target="_blank" href="'+g+'">'+c+"</a></strong>"+k+'<span class="date"><span class="dd">'+h+'</span> <span class="dm">'+q+'</span> <span class="dy">'+m+"</span></span>"+p+"</li>"}!1==a.tagName?g="":(g=encodeURIComponent(a.tagName),g='<div class="taglink"><a target="_blank" href="'+n+"/search/label/"+g+'">'+a.Moretext+"</a></div>");j.html(l+("</ul>"+g)).removeClass(a.loadingClass)}else j.html("<span>No result!</span>").removeClass(a.loadingClass)};e(document).ready(function(){!1==a.tagName?e.ajax({url:n+"/feeds/posts/default?max-results="+a.MaxPost+"&orderby=published&alt=json-in-script",success:k,dataType:"jsonp",cache:!0,error:function(){j.html("<strong>Error Loading Feed!</strong>").removeClass(a.loadingClass)}}):e.ajax({url:n+"/feeds/posts/default/-/"+a.tagName+"?max-results="+a.MaxPost+"&orderby=published&alt=json-in-script",success:k,dataType:"jsonp",cache:!0,error:function(){j.html("<strong>Error Loading Feed!</strong>").removeClass(a.loadingClass)}})})};
window.rccpostsx=function(){return function(e){var b=e||{};e=b.url_blog||"";var s=b.numpostx||8,j=b.id_cintainrp||"#rcentpost",n=b.thumbSize||70,p=b.contjumlah||100,k=b.loadingClass||"loadingxx",t=b.cmtext||"Comments",u=b.firstcmtext||"Comment",v=b.NoCmtext||"No Comment",w=b.MonthNames||"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),x=b.pBlank||"http://1.bp.blogspot.com/-htG7vy9vIAA/Tp0KrMUdoWI/AAAAAAAABAU/e7XkFtErqsU/s1600/grey.gif";$(j).addClass(k);b=e;""===e&&(b=window.location.protocol+"//"+window.location.host);$.ajax({url:b+"/feeds/posts/default?alt=json-in-script&orderby=published&max-results="+s+"",type:"get",dataType:"jsonp",success:function(a){var b,d,h,e,f,q,g,r,l,m="";a=a.feed.entry;if(void 0!==a){for(var m="<ul class='recntpst'>",c=0;c<a.length;c++){for(d=0;d<a[c].link.length;d++)if("alternate"==a[c].link[d].rel){b=a[c].link[d].href;break}for(d=0;d<a[c].link.length;d++)if("replies"==a[c].link[d].rel&&"text/html"==a[c].link[d].type){h=a[c].link[d].title.split(" ")[0];break}f="content"in a[c]?a[c].content.$t:"summary"in a[c]?a[c].summary.$t:"";q="media$thumbnail"in a[c]?a[c].media$thumbnail.url.replace(/\/s[0-9]+\-c/g,"/s"+n+"-c"):x;e=0===h?' <span class="cm">'+v+"</span>":1===h?' <span class="cm">'+h+" "+u+"</span>":' <span class="cm">'+h+" "+t+"</span>";f=f.replace(/<\S[^>]*>/g,"");f.length>p&&(f=f.substring(0,p)+"...");d=a[c].title.$t;g=a[c].published.$t.substring(0,10);r=g.substring(0,4);l=g.substring(5,7);g=g.substring(8,10);l=w[parseInt(l,10)-1];m+='<li><a class="thumbp" href="'+b+'" target="_blank"><img style="width:'+n+"px;height:"+n+'px;display:block" alt="'+d+'"src="'+q+'"/></a><strong><a href="'+b+'" target="_blank">'+d+"</a></strong>"+e+'<span class="date"><span class="dd">'+g+'</span> <span class="dm">'+l+'</span> <span class="dy">'+r+"</span></span><p>"+f+"</p></li>"}$(j).html(m+"</ul>").removeClass(k)}else $(j).html("<span>No result!</span>").removeClass(k)},error:function(){$(j).html("<strong>Error Loading Feed!</strong>").removeClass(k)}})}}();
window.rccommnetsx=function(){return function(d){var a=d||{};d=a.url_blog||"";var j=a.id_containrc||"#rcentcomnets",q=a.numComments||6,m=a.avatarSize||60,r=a.characters||100,k=a.loadingClass||"loadingxx",t=a.defaultAvatar||"http://4.bp.blogspot.com/-AEWksK942OE/UFiyLzXJhiI/AAAAAAAAFKE/jBegaGPClxI/s70/user-anonymous-icon.png",u=a.maxfeeds||50,v=a.MonthNames||"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),w=a.adminBlog||"";$(j).addClass(k);a=d;""===d&&(a=window.location.protocol+"//"+window.location.host);$.ajax({url:a+"/feeds/comments/default?alt=json-in-script&orderby=published",type:"get",dataType:"jsonp",success:function(a){var d=a.feed.entry;if(void 0!==d){a="<ul class='rcomnetxx'>";for(var l=ntotal=0;l<u;l++){var s,g,n,c,e,h;if(l==d.length)break;if(ntotal>=q)break;var b=d[l];for(c=0;c<b.link.length;c++)"alternate"==b.link[c].rel&&(s=b.link[c].href);for(c=0;c<b.author.length;c++)g=b.author[c].name.$t,n=b.author[c].gd$image.src;if(g!=w&&ntotal<q){ntotal++;a+="<li>";c="http://img1.blogblog.com/img/blank.gif"==n?t:n.replace(/\/s[0-9]+(\-c|\/)/,"/s"+m+"$1");e=b.author[0].uri?b.author[0].uri.$t:"#nope";a+='<a target="_blank" class="kmtimg" rel="nofollow" href="'+e+'"><img src="'+c+'"  title="'+g+'" alt="'+g+'" style="width:'+m+"px;height:"+m+'px;display:block"/></a>';e=b.published.$t.substring(0,10);c=e.substring(0,4);var p=e.substring(5,7);e=e.substring(8,10);p=v[parseInt(p,10)-1];h=b.published.$t.substring(11,16);var f=h.substring(0,2),x=h.substring(2,5);h=12>f?"AM":"PM";0===f&&(f=12);12<f&&(f-=12);a+='<div class="ketkomt"><strong><a target="_blank" rel="nofollow" href="'+s+'">'+g+'</a></strong> <span class="date"><span class="dd">'+e+'</span><span class="dmndy"><span class="dm">'+p+'</span><span class="dy">'+c+'</span></span><span class="timex">'+f+x+" "+h+"</span></span></div>";b=b.content.$t.replace(/(<([^>]+)>)/gi,"");""!==b&&b.length>r&&(b=b.substring(0,r),b+="...");a+="<p>"+b+"</p>";a+="</li>"}}$(j).html(a+"</ul>").removeClass(k)}else $(j).html("<span>No result!</span>").removeClass(k)},error:function(){$(j).html("<strong>Error Loading Feed!</strong>").removeClass(k)}})}}();
function SocialBookmarks(){var c=document.getElementById("social-side2");if(c){for(var b=encodeURIComponent(document.title),a=encodeURIComponent(location.protocol+"//"+location.host+location.pathname),d=encodeURIComponent(location.host),b=[{name:"Facebook",url:"http://www.facebook.com/share.php?u="+a+"&t="+b},{name:"Twitter",url:"https://twitter.com/intent/tweet?text="+b+"&amp;url="+a+"&amp;related="},{name:"Google Plus",url:"https://plus.google.com/share?url="+a},{name:"Stumbleupon",url:"http://www.stumbleupon.com/submit?url="+a+"&amp;title="+b},{name:"Digg",url:"http://digg.com/submit?phase=2&amp;url="+a+"&amp;title="+b},{name:"Delicious",url:"http://delicious.com/post?url="+a+"&title="+b},{name:"Linkedin",url:"http://www.linkedin.com/shareArticle?mini=true&url="+a+"&title="+b+"&source="+d},{name:"Reddit",url:"http://reddit.com/submit?url="+a+"&amp;title="+b},{name:"Technorati",url:"http://technorati.com/faves?add="+a}],a=0;a<b.length;a++)c.innerHTML=c.innerHTML+'<li><a class="sc_40 '+b[a].name.replace(" ","_").toLowerCase()+'_40" href="'+b[a].url+'" title="submit to '+b[a].name+'" target="_blank"><span>'+b[a].name+"</span></a></li>";$("#socialarea").append('<span title="Share to.."><b>Share it!</b></span>');$("#socialarea span").toggle(function(){$("#social-side2").animate({left:"0",opacity:1},600).css("overflow","visible");$(this).addClass("active")},function(){$("#social-side2").animate({left:"-300",opacity:0},600).css("overflow","hidden");$(this).removeClass("active")})}};
function relatedPostsWidget(g){var c=jQuery,a={blogURL:"",maxPosts:5,maxTags:5,maxPostsPerTag:5,containerSelector:"",tags:null,loadingText:"",loadingClass:"",relevantTip:"",rlt_summary:100,relatedTitle:"Related Posts",readMoretext:"Read more",rlpBlank:"http://1.bp.blogspot.com/-htG7vy9vIAA/Tp0KrMUdoWI/AAAAAAAABAU/e7XkFtErqsU/s1600/grey.gif",rlt_thumb:55,recentTitle:"Recent Posts",postScoreClass:"",onLoad:!1},a=c.extend({},a,g),p=0,j=null,k=null;a.containerSelector||(document.write('<div id="related_posts"></div>'),a.containerSelector="#related_posts");var l=function(e){p++;if(e.feed.entry)for(var m=0;m<e.feed.entry.length;m++){for(var b=e.feed.entry[m],f="",d=0;d<b.link.length;d++)if("alternate"==b.link[d].rel){f=b.link[d].href;break}d="content"in b?b.content.$t:"summary"in b?b.summary.$t:"";d=d.replace(/<\S[^>]*>/g,"");d.length>a.rlt_summary&&(d=d.substring(0,a.rlt_summary)+"...");var g=b.title.$t,l="media$thumbnail"in b?b.media$thumbnail.url.replace(/\/s[0-9]+\-c/g,"/s"+a.rlt_thumb+"-c"):a.rlpBlank;if(location.href.toLowerCase()!=f.toLowerCase())a:{for(var b=f,h=g,r=d,d=c("li",k),f=0;f<d.length;f++){var n=c("a",d.eq(f)),g=q(n);if(n.attr("href")==b){b=n;h=++g;b.attr("score",h);a.relevantTip&&b.attr("title",a.relevantTip.replace("d",h));a.postScoreClass&&b.attr("class",a.postScoreClass+h);for(b=f-1;0<=b;b--)if(h=c("a",d.eq(b)),q(h)>g){1<f-b&&d.eq(b).after(d.eq(f));break a}0<f&&d.eq(0).before(d.eq(f));break a}}k.append('<li><a class="jdlunya" href="'+b+'" title="'+(a.relevantTip?a.relevantTip.replace("d",1):"")+'"><span class="gmbrrltd"><img style="width:'+a.rlt_thumb+"px;height:"+a.rlt_thumb+'px;display: block" alt="'+h+'" src="'+l+'"/></span><strong>'+h+"</strong></a><p>"+r+'<a target="_blank" title="'+h+'" href="'+b+'">'+a.readMoretext+"</a></p></li>")}}p>=a.tags.length&&(k.attr("class",""),c("#related-posts-loadingtext",j).remove(),0<a.maxPosts&&c("li:gt("+(a.maxPosts-1)+")",k).remove())},q=function(a){a=parseInt(a.attr("score"));return 0<a?a:1};g=function(){if("#related_posts"!=a.containerSelector){var e=c(a.containerSelector);if(1!=e.length)return;j=c('<div id="related_posts"></div>').appendTo(e)}else j=c(a.containerSelector);a.tags||(a.tags=[],c('a[rel="tag"]:lt('+a.maxTags+")").each(function(){var e=c.trim(c(this).text().replace(/\n/g,""));-1==c.inArray(e,a.tags)&&(a.tags[a.tags.length]=e)}));if(0!=a.tags.length||a.recentTitle)if(0==a.tags.length?c("<h4>"+a.recentTitle+"</h4>").appendTo(j):a.relatedTitle&&c("<h4>"+a.relatedTitle+"</h4>").appendTo(j),a.loadingText&&c('<div id="related-posts-loadingtext">'+a.loadingText+"</div>").appendTo(j),k=c("<ul "+(a.loadingClass?'class="'+a.loadingClass+'"':"")+"></ul>").appendTo(j),0==a.tags.length)c.ajax({url:a.blogURL+"/feeds/posts/summary/",data:{"max-results":a.maxPostsPerTag,alt:"json-in-script"},success:l,dataType:"jsonp",cache:!0});else for(e=0;e<a.tags.length;e++)c.ajax({url:a.blogURL+"/feeds/posts/summary/",data:{category:a.tags[e],"max-results":a.maxPostsPerTag,alt:"json-in-script"},success:l,dataType:"jsonp",cache:!0})};a.onLoad?c(window).load(g):c(document).ready(g)};
...
(function(){$(window).scroll(function(){if($(this).scrollTop()>100){$("#top").removeAttr("href");$("#top").stop().animate({bottom:"-2",right:"50%"},{duration:500,queue:false})}else{$("#top").stop().animate({bottom:"-60",right:"50%"},{duration:500,queue:false})}});$(function(){$("#top").click(function(){$("html, body").animate({scrollTop:0},"slow");return false})})})();
...
function AutoSliderRndmRcnt(r){var e=jQuery,a={blogURL:"",MaxPost:5,RandompostActive:!0,idcontaint:"#randompost",ImageSize:400,firstcmtext:"comment",cmtext:"comments",loadingClass:"loadingxx",NumCharacter:100,pBlank:"http://2.bp.blogspot.com/-D47WWjFZXdk/UP1z-A5uCuI/AAAAAAAAH98/heTBvxq49No/s1600/noimage.jpg",NoCmtext:"No Comment",MonthNames:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),timestart:5E3,tagName:!1},a=e.extend({},a,r),p=e(a.idcontaint),h=a.blogURL;""===a.blogURL&&(h=window.location.protocol+"//"+window.location.host);p.html('<div class="box_skitter box_skitter_home maxxi-theme" id="slider-wrapper-maxxi"><ul></ul></div>').addClass(a.loadingClass);var l=function(b){var f,c,g,h,j,l,m,n,k,q="";b=b.feed.entry;for(var d=0;d<b.length;d++){for(c=0;c<b[d].link.length;c++)if("alternate"==b[d].link[c].rel){f=b[d].link[c].href;break}for(c=0;c<b[d].link.length;c++)if("replies"==b[d].link[c].rel&&"text/html"==b[d].link[c].type){g=b[d].link[c].title.split(" ")[0];break}j="content"in b[d]?b[d].content.$t:"summary"in b[d]?b[d].summary.$t:"";j=j.replace(/<\S[^>]*>/g,"");j.length>a.NumCharacter&&(j=j.substring(0,a.NumCharacter)+"...");h=0===g?' <span class="cm">'+a.NoCmtext+"</span>":1==g?' <span class="cm">'+g+" "+a.firstcmtext+"</span>":' <span class="cm">'+g+" "+a.cmtext+"</span>";l="media$thumbnail"in b[d]?b[d].media$thumbnail.url.replace(/\/s[0-9]+\-c/g,"/s"+a.ImageSize):a.pBlank.replace(/\/s[0-9]+(\-c|\/)/,"/s"+a.ImageSize+"$1");c=b[d].title.$t;k=b[d].published.$t.substring(0,10);m=k.substring(0,4);n=k.substring(5,7);k=k.substring(8,10);n=a.MonthNames[parseInt(n,10)-1];q+='<li><a target="_blank" href="'+f+'"><img class="random" src="'+l+'"/></a><div class="label_text"><h4><a target="_blank" href="'+f+'">'+c+'</a></h4><div class="info"><span class="date"><span class="dd">'+k+'</span><span class="dm">'+n+'</span><span class="dy">'+m+"</span></span>"+h+"</div><p>"+j+"</p></div></li>"}e("ul",p).append(q)},m=function(b){Total_Posts_Number=b.feed.openSearch$totalResults.$t;Total_Posts_Number<=a.MaxPost&&(a.MaxPost=Total_Posts_Number);for(b=[];b.length<a.MaxPost;){for(var f=Math.ceil(Math.random()*Total_Posts_Number),c=!1,g=0;g<b.length;g++)if(b[g]==f){c=!0;break}c||(b[b.length]=f)}f="/-/"+a.tagName;!1===a.tagName&&(f="");if(!0===a.RandompostActive)for(c=0;c<a.MaxPost;c++)e.ajax({url:h+"/feeds/posts/default"+f+"?start-index="+b[c]+"&max-results=1&orderby=published&alt=json-in-script",success:l,dataType:"jsonp",cache:!0});else e.ajax({url:h+"/feeds/posts/default"+f+"?max-results="+a.MaxPost+"&orderby=published&alt=json-in-script",success:l,dataType:"jsonp",cache:!0})};e(document).ready(function(){!1===a.tagName?e.ajax({url:h+"/feeds/posts/default?max-results=0&alt=json-in-script",success:m,dataType:"jsonp",cache:!0}):e.ajax({url:h+"/feeds/posts/default/-/"+a.tagName+"?max-results=0&alt=json-in-script",success:m,dataType:"jsonp",cache:!0});e(window).bind("load",function(){setTimeout(function(){e(".box_skitter_home.maxxi-theme").skitter({label:!0,numbers:!0,auto_play:!0,numbers_align:"center",dots:!0,preview:!0,animateNumberOut:{backgroundColor:"#d1d1d1",color:"#FFF"},structure:'<a href="#" class="prev_button"><span>prev</span></a><a href="#" class="next_button"><span>next</span></a><span class="info_slide"></span><div class="container_skitter"><div class="image"><a href=""><img class="image_main" /></a><div class="label_skitter"></div></div></div>',animateNumberOver:{backgroundColor:"#777",color:"#FFF"},width_label:"64%",animateNumberActive:{backgroundColor:"",color:"#fff"},opacity_elements:1});p.removeClass(a.loadingClass);e(".box_skitter_home.maxxi-theme").find(".info_slide_dots .image_number").removeAttr("style")},a.timestart)});e(window).resize(function(){e(".container_skitter,.info_slide_dots").removeAttr("style")})})};